...
function MusicPlayer() {
  return (
    <div className="musicPlayer flex flex-col px-5 w-[130%] border-2 border-black py-3 bg-[#232A4E] rounded-xl mt-5">
        <div className="upperPart flex items-center justify-between">
            <div className="profile flex">
                <img src={mask} alt="mask" className="w-[2.5rem] h-[2.5rem] border-2 border-white rounded-full"/>
            ...
            <div>
                <img src={path} alt="path" className="h-[1rem]" />
            </div>
        </div>
        <div className="lowerPart flex items-center justify-between mt-5">
            <div className="track flex justify-between text-sm text-gray-500 flex-[2] items-center">
                <span>2: 30</span>
                <img src={group9} alt="group9" className="w-[16rem]" />
                <span>4: 30</span>
            </div>
